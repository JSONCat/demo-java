...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="/login" method="post">
      <div class="alert alert-danger alert-dismissible" ${error == null ? "style='display:none;'" :""}>
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input name="isRemenber" type="checkbox" ${isRemenber ? "checked='checked'" : ""}> 记住我
            </label>
          </div>
        </div>
        <!-- /.col -->
