package com.sas.core.util.emay;
...
public class SDKClientTest {
    ...
    public static String sn = "6SDK-EMY-6666-RETRM";// 软件序列号,请通过亿美销售人员获取
    public static String key = "753794";// 序列号首次激活时自己设定
    public static String password = "753794";// 密码,请通过亿美销售人员获取
    public static String baseUrl = "http://sdktaows.eucp.b2m.cn:8080/sdkproxy/";
    ...
    public static void main(String[] args) {
		try {
			...
			case 2:
			    ...
			    break;
			case 3:
			    String mdn = "18611178949";
			    String message = "测试成功";
			    message = URLEncoder.encode(message, Encoding.UTF8.type);
			    String code = "888";
