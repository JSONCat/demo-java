...
import com.sas.core.util.wechat.meta.ApiGetAuthorizerInfoResult;
import com.sas.core.util.wechat.meta.ApiQueryAuthResult;
import com.sas.core.util.wechat.meta.AuthorizerAccessToken;
import com.sas.core.util.wechat.meta.AuthorizerOption;
import com.sas.core.util.wechat.meta.ComponentAccessToken;
import com.sas.core.util.wechat.meta.PreAuthCode;
...
public class ComponentAPI extends BaseAPI{
	 ...
	 * @return
	 */
	public static String componentloginpage(String pre_auth_code, String component_appid, String redirect_uri){
		final StringBuilder sb = new StringBuilder();
		sb.append(PUBLIC_URI + "/cgi-bin/componentloginpage?")
			.append("component_appid=").append(component_appid)
			.append("&pre_auth_code=").append(pre_auth_code)
			.append("&redirect_uri=").append(RequestUtil.encodeURLParam(redirect_uri, redirect_uri));
		return sb.toString();
	}
	 ...
	 * @return
	 */
	public static ApiQueryAuthResult api_query_auth(String authorization_code, String component_access_token,String component_appid){
