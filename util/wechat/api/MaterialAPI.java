...
import com.sas.core.util.wechat.meta.Description;
import com.sas.core.util.wechat.meta.MaterialBatchgetResult;
import com.sas.core.util.wechat.meta.MaterialcountResult;
import com.sas.core.util.wechat.meta.NewsItem;
import com.sas.core.util.wechat.meta.Media;
import com.sas.core.util.wechat.meta.MediaType;
...
public class MaterialAPI extends BaseAPI{
	 ...
	 * @return
	 */
	public static MaterialBatchgetResult materialBatchget(String access_token,String type,int page,int count){
		if (page < 1) page = 1;
		return materialBatchget_material(access_token, type, (page - 1) * count, count);
	}
