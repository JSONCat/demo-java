...
public class ApiGetAuthorizerInfoResult extends BaseResult {
	...
	public static class Authorizer_info {
		...
		public static class Service_type_info {
			...
			public Service_type_info(final Integer id){
				this.id = id;
			}
		...
		public static class Verify_type_info {
			...
			public Verify_type_info(final Integer id){
				this.id = id;
			}
		...
		public static class Business_info {
			...
			public Business_info(Integer open_store, Integer open_scan,
					Integer open_pay, Integer open_card, Integer open_shake) {
				super();
	...
	public static class Authorization_info {
		...
		public Authorization_info(String appid, List<FuncInfo> func_info) {
			super();
			this.appid = appid;
