...
import com.sas.core.util.wxpay.service.IServiceRequest;
...
public class HttpsRequest implements IServiceRequest{
    ...
    public static final Logger logger = Logger.getLogger(HttpsRequest.class);

	private final String certPassword;
	
	private final String certLocalPath;
    ...
    public HttpsRequest(final String certPassword, final String certLocalPath) throws UnrecoverableKeyException, KeyManagementException, 
    ...
    private void init() throws KeyStoreException, KeyManagementException,
    	UnrecoverableKeyException, NoSuchAlgorithmException, IOException
    {
        ...
        try {
        	...
        	TransactionUtil.logOrderMessage("WX-Pay-API-ERROR",e);
        } catch (NoSuchAlgorithmException e) {
        	TransactionUtil.logOrderMessage("WX-Pay-API-ERROR",e);
        } finally {
        	IOUtil.closeStreamWithoutException(instream, null);
        }
    ...
    public String sendPost(String url, Object xmlObj) throws Exception {
        ...
        try {
            ...
            return EntityUtils.toString(entity, Encoding.UTF8.type);
        } catch (Exception e) {
