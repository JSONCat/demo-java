...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
           ...
           // Util.log(WXSignature.getSignFromResponseString(Util.getLocalXMLString("/test/com/tencent/business/refundqueryserviceresponsedata/refundquerysuccess2.xml")));
