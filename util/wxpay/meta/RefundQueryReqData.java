...
public class RefundQueryReqData {
    ...
    public RefundQueryReqData(final String appId, final String mchId, String transactionID,String outTradeNo,
        ...
        //根据API给的签名规则进行签名
        String sign = WXSignature.getSign(toMapForSignature());
