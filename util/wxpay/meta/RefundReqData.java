...
public class RefundReqData {
     ...
     */
    public RefundReqData(final String appId, final String mchId, String transactionID,String outTradeNo,
    		String deviceInfo,String outRefundNo,int totalFee,int refundFee,String opUserID,String refundFeeType){
        ...
        //根据API给的签名规则进行签名
        this.setSign(WXSignature.getSign(this.toMapForSignature()));//把签名数据设置到Sign这个属性中
    ...
    public Map<String, String> toMapForSignature(){
        ...
        if(StringUtils.isNotBlank(op_user_id)){
