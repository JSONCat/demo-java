...
public class ScanPayService extends BaseService {
	...
	public ScanPayService(final String certPassword, final String certLocalPath) throws IllegalAccessException,
		InstantiationException, ClassNotFoundException, UnrecoverableKeyException, 
		KeyManagementException, NoSuchAlgorithmException, KeyStoreException, IOException {
		super(certPassword, certLocalPath, WXPayConstant.PAY_API);
	}
